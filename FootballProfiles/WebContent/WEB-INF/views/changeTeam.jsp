...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand js-scroll-trigger" href="#page-top">${origTeam.teamName }</a>
			<button
	...
	<section class="bg-primary text-white mb-0" id="about">
		<div class="container">
			<h2 class="text-center text-uppercase text-white">Update ${origTeam.teamName }</h2>
				...
				<div class="form-row">
					<div class="form-group col-md-3">
						<label for="inputPassword4">Team ID</label> <input type="text"
							name="teamID" required class="form-control" readonly="readonly" id="inputPassword4"
							placeholder="Id" value="${origTeam.id }">
					</div>
				
					<div class="form-group col-md-3">
						<label for="inputEmail4">Team Name</label> <input type="text"
							class="form-control" id="inputEmail4" name="teamName" required
							placeholder="Team Name" value="${origTeam.teamName }">
					</div>
					<div class="form-group col-md-3">
						<label for="inputPassword4">City</label> <input type="text"
							name="city" required class="form-control" id="inputPassword4"
							placeholder="City" value="${origTeam.city }">
					</div>
					<div class="form-group col-md-3">
						<label for="inputPassword4">Country</label> <input type="text"
							name="country" required class="form-control" id="inputPassword4"
							placeholder="Country" value="${origTeam.country }">
					</div>
				</div>
